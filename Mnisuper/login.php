...
<head>
    ...
    <style>
        body {
            background-color: #C5D0E7; /* Cambia el color de fondo según tus preferencias */
        ...
        .custom-card {
            ...
            background-color: #ffffff; /* Cambia el color de fondo de la tarjeta según tus preferencias */
            color: #000000; /* Cambia el color del texto en la tarjeta para que sea legible */
        }
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card custom-card card-animation"> <!-- Utiliza la clase personalizada custom-card y la clase de animación -->
                    ...
                    <div class="logo">
                        <!-- Agrega tu logo aquí -->
                        <img src="LOGO.jpeg" alt="170" width="170">
                    </div>
                    <div class="card-body">
                        <form method="post" action="auth.php">
                            <div class="form-group">
                                <label for="usuario">Nombre de usuario</label>
                                <input type="text" class="form-control rounded-pill" id="usuario" name="usuario" placeholder="Ingrese su nombre de usuario" required>
                            </div>
                            <div class="form-group">
                                <label for="contraseña">Contraseña</label>
                                <div class="input-group">
                                    <input type="password" class="form-control rounded-pill" id="contraseña" name="contraseña" placeholder="Ingrese su contraseña" required>
